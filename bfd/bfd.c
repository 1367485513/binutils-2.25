...
/* provide storage for subsystem, stack and heap data which may have been
   passed in on the command line.传入  Ld puts this data into a bfd_link_info
...
/*
INODE
Error reporting, Miscellaneous 902, typedef bfd, BFD front end
有reloc信息【902-1000】
...
DESCRIPTION
	...
	this function.
  设置打印BFD错误时要使用的程序名称。 在错误消息之前打印，后跟冒号和空格。
   传递给此函数后，不得更改字符串。
*/
